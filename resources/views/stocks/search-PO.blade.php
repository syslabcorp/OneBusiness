...
<tr class="stockRow">
    ...
    <td><input type="text" class="form-control text-center subtotal" name="stocks[{{ $loop->index+1 }}][subtotal]" value="{{ ($item->Qty - $item->ServedQty) * $item->cost }}" autocomplete="off"></td>
