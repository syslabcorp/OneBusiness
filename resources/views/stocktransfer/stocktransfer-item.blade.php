    ...
    <tbody>
      ...
      <tr class="stocktransferRow">
        <td class="text-center">
          ...
          <input type="text" data-column="item_code" class="form-control text-center item_code showSuggest" name="details[{{ $loop->index+1 }}][item_code]" value="{{ $row->item->ItemCode }}" >
        </td>
        ...
        <td><input type="text" class="form-control text-center" name="details[{{ $loop->index+1 }}][qty]" value="{{ $row->Qty ? $row->Qty : ''}}" autocomplete="off"></td>
      ...
      <tr class="newStocktransfer" style="display: none;">
        <td class="text-center">
          ...
          <input type="text"   data-column="item_code"  class="form-control item_code text-center showSuggest" name="item_code">
        </td>
        ...
        <td><input type="text" data-hand="" name="qty" class="form-control text-center " value="0" autocomplete="off"></td>
        <td class="text-center"><label></label></td>
