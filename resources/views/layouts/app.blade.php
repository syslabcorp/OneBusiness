...
<head>
    ...
    <link href="{{ asset('biomertic-login/assets/css/ajaxmask.css') }}" rel="stylesheet">
	...
	<!--[if lt IE 9]>
	<script src="{{ asset('biomertic-login/assets/js/html5shiv.min.js') }}"></script>
	<script src="{{ asset('biomertic-login/assets/js/respond.min.js') }}"></script>
<![endif]-->
...
<script src="{{ asset('/biomertic-login/assets/js/jquery.timer.js') }}"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="{{ asset('/biomertic-login/assets/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('/biomertic-login/assets/js/ajaxmask.js') }}"></script>

<script src="{{ asset('/biomertic-login/assets/js/custom.js') }}"></script>
