    ...
    <tbody>
      ...
      <tr class="stockRow">
        <td class="text-center">
          ...
          <input type="text" class="form-control text-center item_code showSuggest" name="stocks[{{ $loop->index+1 }}][item_code]" value="{{ $row->item ? $row->item->ItemCode : '' }}" >
        </td>
      ...
      <tr class="newStock" style="display: none;">
        <td class="text-center">
          ...
          <input type="text"   class="form-control item_code text-center showSuggest" name="item_code">
        </td>
