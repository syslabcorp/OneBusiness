    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">List Modules<a href="{{ URL('add_module') }}" class="pull-right">Add Module</a></div>
                        ...
                        <tbody>
                            @foreach($detail as $key=>$det)
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary btn-md" data-title="Edit" href="{{ URL::to('add_module/' . $det->module_id) }}"><span class="glyphicon glyphicon-pencil"></span></a>
                                    <a class="btn btn-danger btn-md sweet-4" data-title="Delete" href="javascript:;" rel="{{ URL::to('delete_module/' . $det->module_id) }}"><span class="glyphicon glyphicon-trash"></span></a></td>
                                </tr>  
                            @endforeach
                        </tbody>
                    </table>
